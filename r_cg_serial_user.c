...
static void r_iic00_callback_master_receiveend(void)
{
	...
	else if(P9261_IIC_FLOW==0xDA)
	{
		...
		P9261_Address[0] = 0x0B;
		P9261_Address[1] = 0xDD;
		P9261_IIC_FLOW = 0xDB;
	}
	//-------capture coil q data ---------------------------------------------//
	else if(P9261_IIC_FLOW==0xDB)
	{
		P9261_Reg_State.RPP = P9261_Message;
		P9261_Reg_State.RPP = P9261_Reg_State.RPP<<8;
		P9261_Address[0] = 0x0B;
		P9261_Address[1] = 0xDC;
		P9261_IIC_FLOW = 0xDC;
	}
	else if(P9261_IIC_FLOW==0xDC)
	{
		P9261_Reg_State.RPP |= P9261_Message;
		COIL_Current = P9261_Reg_State.RPP;
		P9261_Address[0] = 0x06;

...
{
	unsigned char In_Charge_complete_From_Rx	:1;
	unsigned char In_Charging					:1;
	unsigned char In_Standby					:1;
	unsigned char In_Open_FOD					:1;
	unsigned char In_Ploss_FOD					:1;
	unsigned char Reserved_Status				:3;
};
...
struct P9261_STATE_MESSAGE
{
	...
	//unsigned long	Reserved_Status							:1;
};

...
volatile unsigned int *led_state_flag_address;
...
* Return Value : None
***********************************************************************************************************************/
unsigned char Clear_Led_State_Flag(unsigned long const *address)
{
...
void Error_LED_Flash_Task(void)
{
	...
	else
	{
		CHARGE_STATE_LED_OFF;
		Clear_Led_State_Flag(&LED_Status);
		LED_Status.LED_Working_End_Flag = TRUE; // 20191016 modify //
	}
}
/***********************************************************************************************************************
